...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // productcategoryiconskkd (1:3906)
        width: double.infinity,
        height: 215*fem,
