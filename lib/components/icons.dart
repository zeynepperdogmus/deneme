      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              // typeprofilestatedefaultPSD (1:225)
            ...
            Container(
              // typeproductsstatedefaultLeH (1:708)
            ...
            Container(
              // typestatsstatedefaulth7T (1:709)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 3*fem),
              width: 24*fem,
              height: 24*fem,
              child: Image.asset(
            ...
            Container(
              // typehidestatedefaultgVB (1:1097)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 3*fem),
              width: 19*fem,
              height: 14*fem,
              child: Image.asset(
            ...
            Container(
              // typeshowstatedefault51X (1:1100)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 3*fem),
              width: 19*fem,
              height: 16*fem,
              child: Image.asset(
            ...
            Container(
              // typeheartstatedefaultSmB (1:824)
            ...
            Container(
              // typeheartstateenabledR7K (1:1334)
            ...
            Container(
              // typeprivacystatedefaultNKP (1:4335)
            ...
            Container(
              // typenotificationsstatedefaultM (1:4334)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 18*fem, 0.2*fem),
              width: 40*fem,
              height: 38.8*fem,
              child: Image.asset(
            ...
            Container(
              // typesearchhistorystatedefaultu (1:4333)
            ...
            Container(
              // typelogoutstatedefault6Aq (1:4336)
